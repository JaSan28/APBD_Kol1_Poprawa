    ...
    public class CarRentalService : ICarRentalService
    {
        ...
        public async Task<ClientRentalsDto> GetClientRentalsAsync(int clientId)
        {
            ...
            var query = @"
                SELECT c.ID, c.FirstName, c.LastName, c.Address,
                       cr.VIN, col.Name AS Color, m.Name AS Model,
        ...
        public async Task<int> AddClientWithRentalAsync(NewClientRentalDto newClientRental)
        {
            ...
            try
            {
                ...
                await using var insertClientCommand = new SqlCommand(insertClientQuery, connection, (SqlTransaction)transaction);
                ...
                await using var insertRentalCommand = new SqlCommand(insertRentalQuery, connection, (SqlTransaction)transaction);
